...
def upgrade() -> None:
    ...
    op.create_index(
        "ix_customer_profiles_workspace_segment", "customer_profiles", ["workspace_id", "segment"]
    )
    op.execute(
        sa.text(
    ...
    op.create_index(
        "ix_product_reviews_workspace_product", "product_reviews", ["workspace_id", "product_id"]
    )
    op.create_index(
        "ix_product_reviews_workspace_sentiment", "product_reviews", ["workspace_id", "sentiment"]
    )
    ...
    op.create_index(
        "ix_refund_cases_workspace_category", "refund_cases", ["workspace_id", "category"]
    )
    op.create_index(
        "ix_refund_cases_workspace_product", "refund_cases", ["workspace_id", "product_id"]
    )
    ...
    op.create_index(
        "ix_customer_knowledge_customer_id", "customer_knowledge_entries", ["customer_id"]
    )
    op.create_index(
        "ix_customer_knowledge_product_id", "customer_knowledge_entries", ["product_id"]
    )
    op.create_index(
        "ix_customer_knowledge_entry_type", "customer_knowledge_entries", ["entry_type"]
    )
