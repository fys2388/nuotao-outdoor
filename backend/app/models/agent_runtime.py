...
class AgentRegistry(Base, TimestampMixin, WorkspaceMixin):
    ...
    model_provider: Mapped[str] = mapped_column(String(32), nullable=False, default="sensenova")
    model_name: Mapped[str] = mapped_column(String(64), nullable=False, default="sensenova-6.8-flash-lite")
